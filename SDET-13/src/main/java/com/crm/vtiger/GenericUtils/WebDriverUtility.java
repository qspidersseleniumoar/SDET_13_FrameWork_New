...
public class WebDriverUtility {
   ...
   {
	   driver.manage().timeouts().implicitlyWait(IContants.implicitWiat, TimeUnit.SECONDS);
   ...
   {
	  WebDriverWait wait = new WebDriverWait(driver, IContants.explicitWait);
   ...
   {
	   int count = 0;
       while(count<IContants.explicitWait) {
    	   try {
    	   element.click();
    	   break;
    	   }
